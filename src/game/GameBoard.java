...
public class GameBoard {
	...
	public GameBoard(Dice dice) {
		...
		field[1] = new Territory("Rødovrevej", 60, 2, 10, 30, 90, 160, 250);
		field[2] = new Chance();
		...
		field[22] = new Chance();
		field[23] = new Territory("Østerbrogade", 220, 18, 90, 250, 700, 875, 1050);
		field[24] = new Territory("Grønningen", 240, 20, 100, 300, 750, 925, 1100);
		...
		field[39] = new Territory("Rådhuspladsen", 400, 50, 200, 600, 1400, 1700, 2000);
	}
